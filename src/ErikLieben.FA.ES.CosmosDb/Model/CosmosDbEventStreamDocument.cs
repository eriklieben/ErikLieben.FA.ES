...
/// <summary>
/// Represents an object document for CosmosDB that wraps stream metadata.
/// </summary>
public class CosmosDbEventStreamDocument : ObjectDocument
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CosmosDbEventStreamDocument"/> class.
    /// </summary>
    ...
    public CosmosDbEventStreamDocument(
        string objectId,
        string objectName,
    ...
    /// <summary>
    /// Creates a <see cref="CosmosDbEventStreamDocument"/> from an existing <see cref="IObjectDocument"/> instance, copying common metadata.
    /// </summary>
    /// <param name="objectDocument">The source object document.</param>
    /// <returns>A new <see cref="CosmosDbEventStreamDocument"/> with values copied from <paramref name="objectDocument"/>.</returns>
    public static CosmosDbEventStreamDocument From(IObjectDocument objectDocument)
    {

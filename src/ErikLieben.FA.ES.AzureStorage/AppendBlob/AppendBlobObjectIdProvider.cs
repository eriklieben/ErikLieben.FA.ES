...
/// for the Append Blob storage provider.
/// Uses continuation tokens for efficient pagination through large object collections.
/// </summary>
public class AppendBlobObjectIdProvider : IObjectIdProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AppendBlobObjectIdProvider"/> class.
    /// </summary>
    ...
    public AppendBlobObjectIdProvider(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var client = clientFactory.CreateClient(appendBlobSettings.DefaultDocumentStore);
        var container = client.GetBlobContainerClient(appendBlobSettings.DefaultDocumentContainerName);

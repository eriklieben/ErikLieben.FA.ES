...
/// </summary>
public class SerializeAppendBlobEventStreamDocument
{
    /// <summary>
    ...
    /// </summary>
    public static SerializeAppendBlobEventStreamDocument From(IObjectDocument source)
    {
        return new SerializeAppendBlobEventStreamDocument
        {
...
[JsonSerializable(typeof(SerializeAppendBlobEventStreamDocument))]
internal partial class SerializeAppendBlobEventStreamDocumentContext : JsonSerializerContext
{
}

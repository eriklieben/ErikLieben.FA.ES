...
public interface IObjectDocumentFactory
{
    ...
    Task<IObjectDocument> GetAsync(string objectName, string objectId, string? store = null!, string? documentType = null!, CancellationToken cancellationToken = default);
    ...
    Task<IObjectDocument> GetOrCreateAsync(string objectName, string objectId, string? store = null!, string? documentType = null!, CancellationToken cancellationToken = default);
    ...
    Task<IObjectDocument?> GetFirstByObjectDocumentTag(string objectName, string objectDocumentTag, string? documentTagStore = null, string? store = null, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<IObjectDocument>> GetByObjectDocumentTag(string objectName, string objectDocumentTag, string? documentTagStore = null, string? store = null, CancellationToken cancellationToken = default);
    ...
    Task SetAsync(IObjectDocument document, string? store = null!, string? documentType = null!, CancellationToken cancellationToken = default);
}

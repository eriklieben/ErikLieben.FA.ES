...
public class AnalyzeAggregates
{
    ...
    public void Run(List<AggregateDefinition> aggregates)
    {
        ...
        declaration.EventStreamTypeAttribute = ExtractEventStreamTypeAttribute(classSymbol);
        declaration.EventStreamBlobSettingsAttribute = ExtractEventStreamBlobSettingsAttribute(classSymbol);

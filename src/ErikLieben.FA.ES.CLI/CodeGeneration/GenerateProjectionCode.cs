...
public class GenerateProjectionCode
{
        ...
        string postWhenCode, string postWhenAllDummyCode)
    {
        ...
        return $$$"""
                  #nullable enable
                  /// <summary>
                  /// Applies an event to the projection by dispatching to the appropriate When method.
                  /// </summary>
        ...
        string? path)
    {
        ...
        code.AppendLine($$"""
                          ...
                          // <auto-generated />
                          /// <summary>
                          /// {{projection.Name}} projection for materializing read models from event streams.
                          /// </summary>
                          public partial class {{projection.Name}} : I{{projection.Name}} {

                              /// <summary>
                              /// Initializes a new instance of the {{projection.Name}} class.
                              /// </summary>
                              public {{projection.Name}}() : base() {
                              }

                              /// <summary>
                              /// Initializes a new instance of the {{projection.Name}} class with required factories.
                              /// </summary>
                              /// <param name="documentFactory">Factory for managing object documents.</param>
                              /// <param name="eventStreamFactory">Factory for creating event streams.</param>
                              ...
                              /// <summary>
                              /// Gets the factory methods for resolving When method parameters from execution context.
                              /// </summary>
                              ...
                              /// <summary>
                              /// Loads a {{projection.Name}} instance from JSON string with complete state restoration.
                              /// </summary>
                              /// <param name="json">The JSON string containing the serialized projection state.</param>
                              /// <param name="documentFactory">Factory for managing object documents.</param>
                              /// <param name="eventStreamFactory">Factory for creating event streams.</param>
                              ...
                              /// <summary>
                              /// Serializes the projection to JSON string.
                              /// </summary>
                              /// <returns>JSON representation of the projection state.</returns>

...
/// <summary>
/// Generates supporting partial classes for inherited aggregates.
/// </summary>
public class InheritedAggregateCodeGenerator : CodeGeneratorBase
{
    public override string Name => "Inherited Aggregates";

    public InheritedAggregateCodeGenerator(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var legacyGenerator = new GenerateInheritedAggregateCode(solution, Config, solutionPath);

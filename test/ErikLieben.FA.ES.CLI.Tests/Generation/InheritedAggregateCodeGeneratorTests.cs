...
public class InheritedAggregateCodeGeneratorTests
{
    public class Constructor : InheritedAggregateCodeGeneratorTests
    {
        [Fact]
        public void Should_create_instance()
        {
            ...
            // Act
            var sut = new InheritedAggregateCodeGenerator(logger, codeWriter, config);

            // Assert
            Assert.NotNull(sut);
            Assert.Equal("Inherited Aggregates", sut.Name);
        }
    }

    public class GenerateAsyncMethod : InheritedAggregateCodeGeneratorTests
    {
        [Fact]
        public async Task Should_log_generation_started()
        {
            ...
            Assert.Contains(logger.GetActivityLog(), e =>
                ...
                e.Message.Contains("Inherited Aggregates"));
        }

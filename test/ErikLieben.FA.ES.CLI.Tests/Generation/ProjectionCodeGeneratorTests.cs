...
public class ProjectionCodeGeneratorTests
{
    public class Constructor : ProjectionCodeGeneratorTests
    {
        [Fact]
        public void Should_create_instance()
        {
            ...
            // Act
            var sut = new ProjectionCodeGenerator(logger, codeWriter, config);

            // Assert
            Assert.NotNull(sut);
            Assert.Equal("Projections", sut.Name);
        }
    }

    public class GenerateAsyncMethod : ProjectionCodeGeneratorTests
    {
        [Fact]
        public async Task Should_log_generation_started()
        {
            ...
            Assert.Contains(logger.GetActivityLog(), e =>
                ...
                e.Message.Contains("Projections"));
        }

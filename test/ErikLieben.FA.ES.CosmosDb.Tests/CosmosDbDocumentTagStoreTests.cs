...
public class CosmosDbDocumentTagStoreTests
{
    ...
    public CosmosDbDocumentTagStoreTests()
    {
    ...
    public class Constructor : CosmosDbDocumentTagStoreTests
    {
        [Fact]
        public void Should_throw_argument_null_exception_when_cosmos_client_is_null()
        {
            Assert.Throws<ArgumentNullException>(() => new CosmosDbDocumentTagStore(null!, settings));
        }

        [Fact]
        public void Should_throw_argument_null_exception_when_settings_is_null()
        {
            Assert.Throws<ArgumentNullException>(() => new CosmosDbDocumentTagStore(cosmosClient, null!));
        }

        [Fact]
        public void Should_create_instance_when_all_parameters_are_valid()
        {
            var sut = new CosmosDbDocumentTagStore(cosmosClient, settings);
            Assert.NotNull(sut);
        }
    }

    public class SetAsync : CosmosDbDocumentTagStoreTests
    {
        [Fact]
        ...
        [Fact]
        public async Task Should_throw_argument_exception_when_stream_identifier_is_null_or_empty()
        {
            var sut = new CosmosDbDocumentTagStore(cosmosClient, settings);
        ...
        [Fact]
        public async Task Should_upsert_tag_entity()
        {
            var sut = new CosmosDbDocumentTagStore(cosmosClient, settings);
    ...
    public class GetAsync : CosmosDbDocumentTagStoreTests
    {
        ...
        [Fact]
        public async Task Should_return_object_ids_when_tags_found()
        {
            var sut = new CosmosDbDocumentTagStore(cosmosClient, settings);
    ...
    public class ContainerCaching : CosmosDbDocumentTagStoreTests
    {
        [Fact]
    ...
    public class AutoCreateContainers : CosmosDbDocumentTagStoreTests
    {
        [Fact]
        public async Task Should_create_database_and_container_when_auto_create_is_enabled()
        {
            ...
            var sut = new CosmosDbDocumentTagStore(cosmosClient, autoCreateSettings);
    ...
    public class RemoveAsync : CosmosDbDocumentTagStoreTests
    {
        [Fact]
        public async Task Should_throw_argument_null_exception_when_document_is_null()
        {

...
{
    public class ProjectionWithExternalCheckpointAttributeTests
    {
        [Fact]
        public void Should_implement_attribute()
        {
            // Arrange & Act
            var sut = new ProjectionWithExternalCheckpointAttribute();
        ...
        {
            // Arrange & Act
            var attributes = typeof(ProjectionWithExternalCheckpointAttribute)

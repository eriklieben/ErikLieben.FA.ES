...
public partial class WorkItemCountByProject : IWorkItemCountByProject
{

    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    public WorkItemCountByProject() : base()
    {
    }

    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    public WorkItemCountByProject(IObjectDocumentFactory documentFactory, IEventStreamFactory eventStreamFactory)
    ...
    public override Task Fold<T>(IEvent @event, VersionToken versionToken, T? data = default(T?), IExecutionContext? parentContext = null) where T : class
    {
        ...
        switch (@event.EventType)
        {
            case "WorkItem.Planned":
                When(JsonEvent.ToEvent(@event, WorkItemPlannedJsonSerializerContext.Default.WorkItemPlanned).Data());
                break;
        }
...
#nullable restore
    ...
    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    public static WorkItemCountByProject? LoadFromJson(string json, IObjectDocumentFactory documentFactory, IEventStreamFactory eventStreamFactory)
    {
        // Deserialize each property manually to preserve data
        System.Collections.Generic.Dictionary<System.String, System.Int32>? countByProject = null;
        ...
        while (reader.Read())
        {
            ...
            {
                case "CountByProject":
                    countByProject = JsonSerializer.Deserialize<System.Collections.Generic.Dictionary<System.String, System.Int32>>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "$checkpoint":
                    checkpoint = JsonSerializer.Deserialize<ErikLieben.FA.ES.Checkpoint>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options) ?? [];
                    break;
                case "CodeSchemaVersion":
                    codeSchemaVersion = JsonSerializer.Deserialize<System.Int32>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "$checkpointFingerprint":
                    checkpointFingerprint = JsonSerializer.Deserialize<System.String>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "Status":
                    status = JsonSerializer.Deserialize<ErikLieben.FA.ES.Projections.ProjectionStatus>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "StatusChangedAt":
                    statusChangedAt = JsonSerializer.Deserialize<System.Nullable<System.DateTimeOffset>>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "RebuildInfo":
                    rebuildInfo = JsonSerializer.Deserialize<ErikLieben.FA.ES.Projections.RebuildInfo>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "SchemaVersion":
                    schemaVersion = JsonSerializer.Deserialize<System.Int32>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
                case "NeedsSchemaUpgrade":
                    needsSchemaUpgrade = JsonSerializer.Deserialize<System.Boolean>(ref reader, WorkItemCountByProjectJsonSerializerContext.Default.Options);
                    break;
            }
        }

        // Create instance with factories and deserialized properties
        var instance = new WorkItemCountByProject(documentFactory, eventStreamFactory);

        if (countByProject != null)
        {
            foreach (var kvp in countByProject)
            {
                instance.CountByProject[kvp.Key] = kvp.Value;
            }
        }
    ...
    {
        return JsonSerializer.Serialize(this, WorkItemCountByProjectJsonSerializerContext.Default.WorkItemCountByProject);
    }
...
// <auto-generated />
/// <summary>
/// Interface defining the public state properties of WorkItemCountByProject.
/// </summary>
public interface IWorkItemCountByProject
{
    public Dictionary<System.String, System.Int32>? CountByProject { get; }
...
[JsonSerializable(typeof(System.Collections.Generic.Dictionary<System.String, System.Int32>))]
...
[JsonSerializable(typeof(WorkItemCountByProject))]
// <auto-generated />
/// <summary>
/// JSON serializer context for WorkItemCountByProject types.
/// </summary>
internal partial class WorkItemCountByProjectJsonSerializerContext : JsonSerializerContext
{
}

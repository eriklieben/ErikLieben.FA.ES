...
public partial class UserProfilePage : IUserProfilePage
{
    ...
    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    public UserProfilePage(IObjectDocumentFactory documentFactory, IEventStreamFactory eventStreamFactory)
...
#nullable restore
    ...
    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    public static UserProfilePage? LoadFromJson(string json, IObjectDocumentFactory documentFactory, IEventStreamFactory eventStreamFactory)
    {
        ...
        while (reader.Read())
        {
            ...
            {
                case "PageNumber":
                    pageNumber = JsonSerializer.Deserialize<System.Int32>(ref reader, UserProfilePageJsonSerializerContext.Default.Options);
                    break;
                case "Users":
                    users = JsonSerializer.Deserialize<System.Collections.Generic.Dictionary<System.String, TaskFlow.Domain.Projections.UserProfileInfo>>(ref reader, UserProfilePageJsonSerializerContext.Default.Options);
                    break;
                case "$checkpoint":
                ...
                case "$checkpointFingerprint":
                    ...
                    break;
                case "Status":
                    status = JsonSerializer.Deserialize<ErikLieben.FA.ES.Projections.ProjectionStatus>(ref reader, UserProfilePageJsonSerializerContext.Default.Options);
                    break;
                case "StatusChangedAt":
                    statusChangedAt = JsonSerializer.Deserialize<System.Nullable<System.DateTimeOffset>>(ref reader, UserProfilePageJsonSerializerContext.Default.Options);
                    break;
                case "RebuildInfo":
                    rebuildInfo = JsonSerializer.Deserialize<ErikLieben.FA.ES.Projections.RebuildInfo>(ref reader, UserProfilePageJsonSerializerContext.Default.Options);
                    break;
                case "SchemaVersion":
        ...
        if (users != null)
        {
            ...
            {
                instance.Users[kvp.Key] = kvp.Value;
            }
        }
    ...
    {
        return JsonSerializer.Serialize(this, UserProfilePageJsonSerializerContext.Default.UserProfilePage);
    }
...
/// <summary>
/// Factory for creating and managing UserProfilePage blob-based projections.
/// </summary>
public partial class UserProfilePageFactory(
    IAzureClientFactory<BlobServiceClient> blobServiceClientFactory,
    IObjectDocumentFactory objectDocumentFactory,
    IEventStreamFactory eventStreamFactory)
    : BlobProjectionFactory<UserProfilePage>(
        blobServiceClientFactory,
        "BlobStorage",
        "projections/userprofiles/page-{pageNumber}.json")
{
    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    ...
    [GeneratedCode("ErikLieben.FA.ES", "1.0.0.0")]
    [ExcludeFromCodeCoverage]
    protected override UserProfilePage New()
    {
        return new UserProfilePage(objectDocumentFactory, eventStreamFactory);
    }

    /// <summary>
    /// Loads a UserProfilePage instance from JSON with complete state restoration.
    /// </summary>
    ...
    /// <returns>A UserProfilePage instance with restored state, or null if deserialization fails.</returns>
    protected override UserProfilePage? LoadFromJson(string json, IObjectDocumentFactory documentFactory, IEventStreamFactory eventStreamFactory)
    {
        return UserProfilePage.LoadFromJson(json, documentFactory, eventStreamFactory);
    }
}
...
// <auto-generated />
/// <summary>
/// Interface defining the public state properties of UserProfilePage.
/// </summary>
...
[JsonSerializable(typeof(System.Collections.Generic.Dictionary<System.String, TaskFlow.Domain.Projections.UserProfileInfo>))]
[JsonSerializable(typeof(TaskFlow.Domain.Projections.UserProfileInfo))]
...
// <auto-generated />
/// <summary>
/// JSON serializer context for UserProfilePage types.
/// </summary>
internal partial class UserProfilePageJsonSerializerContext : JsonSerializerContext
{
}

        ...
        while (reader.Read())
        {
            ...
            switch (propertyName)
            {
                ...
                case "$checkpointFingerprint":
                    ...
                    break;
                case "Status":
                    status = JsonSerializer.Deserialize<ErikLieben.FA.ES.Projections.ProjectionStatus>(ref reader, EventUpcastingDemonstrationJsonSerializerContext.Default.Options);
                    break;
                case "StatusChangedAt":
                    statusChangedAt = JsonSerializer.Deserialize<System.Nullable<System.DateTimeOffset>>(ref reader, EventUpcastingDemonstrationJsonSerializerContext.Default.Options);
                    break;
                case "RebuildInfo":
                    rebuildInfo = JsonSerializer.Deserialize<ErikLieben.FA.ES.Projections.RebuildInfo>(ref reader, EventUpcastingDemonstrationJsonSerializerContext.Default.Options);
                    break;
                case "SchemaVersion":

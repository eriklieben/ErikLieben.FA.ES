...
public partial class WorkItem : Aggregate, IBase, IWorkItem
{
    ...
    {
        // Call the partial method implementation from WorkItem.cs
        ProcessSnapshotImpl(snapshot);
    }

    /// <summary>
    /// Partial method for snapshot processing implementation.
    /// Implement this in the non-generated partial class to restore state from a snapshot.
    /// </summary>
...
public partial class WorkItemFactory : IWorkItemFactory
{
    ...
    /// <returns>A new WorkItem instance.</returns>
    public async Task<WorkItem> CreateAsync(WorkItemId id)
    {
    ...
    public async Task<WorkItem> GetAsync(WorkItemId id, int? upToVersion = null)
    {
    ...
    public async Task<(WorkItem, IObjectDocument)> GetWithDocumentAsync(WorkItemId id)
    {
        var document = await this.objectDocumentFactory.GetAsync(ObjectName, id.ToString(), null, null);
        var obj = Create(document);
        await obj.Fold();

...
// Register demo webhook services for idempotency testing
builder.Services.AddSingleton<TaskFlow.Api.Actions.DemoWebhookOptions>();
builder.Services.AddSingleton<TaskFlow.Api.Actions.DemoWebhookAction>();

...
public partial class CatppuccinHtmlExporter : IExporter
{
    ...
    private static void AppendTimeUnitsLegend(StringBuilder sb)
    {
        ...
        sb.AppendLine("        <div class=\"unit\"><span class=\"unit-name\">μs</span><span class=\"unit-desc\">microseconds (1 millionth of a second)</span></div>");
    ...
    private static string FormatTime(double nanoseconds)
    {
        return nanoseconds switch
        {
            ...
            < 1000000 => $"{nanoseconds / 1000:F2} μs",

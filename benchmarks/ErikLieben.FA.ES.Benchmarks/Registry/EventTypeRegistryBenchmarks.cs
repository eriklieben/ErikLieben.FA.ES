...
[BenchmarkCategory("Registry", "Lookup")]
public class EventTypeRegistryBenchmarks
{
    ...
    {
        // Use first event in registry (always exists regardless of EventTypeCount)
        return _frozenRegistry.GetByName("Event_0");
    }
    ...
    {
        // Use first event in registry (always exists regardless of EventTypeCount)
        return _mutableRegistry.GetByName("Event_0");
    }
}
